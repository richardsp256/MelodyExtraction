...
all: comparison.c comparison.h midi.c midi.h main.c pitchStrat.o onsetStrat.o onsetsds.o HPSDetection.o BaNaDetection.o findpeaks.o findCandidates.o candidateSelection.o lists.o 
	...
	gcc midi.o comparison.o pitchStrat.o onsetStrat.o onsetsds.o HPSDetection.o BaNaDetection.o findpeaks.o findCandidates.o candidateSelection.o lists.o main.o -o extract -L./fftw-3.3.4/.libs -lfftw3f -L./libsndfile-1.0.26/src/.libs -lsndfile -lm
